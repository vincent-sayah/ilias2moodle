...
require_once(__DIR__ . '/../classes/phase7_wiki_author_executor.php');
...
$help = "ILIAS2Moodle Phase 7.6 Wiki metadata apply\n\n"
    . "php local/iliasmigration/cli/phase7_wiki_author_apply.php "
    . "--source=/tmp/phase76_wiki_801_authors.json "
    . "--course=5 --wiki-ref=273\n\n"
    . "Reconciles current-page author/timestamps only. "
    . "No Wiki page, content, asset or revision is created.\n";
...
try {
    ...
    $result = (
        new \local_iliasmigration\phase7_wiki_author_executor()
    )->execute(
        $source,
        $courseid,
        $wikiref
