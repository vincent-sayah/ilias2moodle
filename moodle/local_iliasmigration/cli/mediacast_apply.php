...
$help = "ILIAS2Moodle MediaCast apply\n\n"
    . "php local/iliasmigration/cli/mediacast_apply.php "
    . "--source=/path/to/migration.json --category=ID\n\n"
    . "Creates or updates one Moodle mod_data activity per selected ILIAS "
    . "MediaCast and one Database record per source item.\n";
...
$executor = new \local_iliasmigration\phase65_mediacast_executor($source);
