...
$help = "ILIAS2Moodle Exercise dry-run\n\n"
...
// Exercise migration is incremental. Earlier completed phases are represented
// by persistent Moodle mappings; only the Exercise package and exact parent
// target required for this object are validated here.
$plan = (new \local_iliasmigration\phase65_exercise_package_validator($source))->validate($plan);
$plan['mode'] = 'dry-run';
