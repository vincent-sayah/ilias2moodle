...
$help = "ILIAS2Moodle Blog apply\n\n"
    . "php local/iliasmigration/cli/blog_apply.php "
    . "--source=/path/to/migration.json --category=ID\n\n"
    . "Creates or updates one Moodle mod_data activity per selected ILIAS "
    . "Blog and one Database record per source posting.\n";
...
$executor = new \local_iliasmigration\phase65_blog_executor($source);
