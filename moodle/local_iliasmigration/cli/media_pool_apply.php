...
$help = "ILIAS2Moodle Media Pool apply\n\n"
    . "php local/iliasmigration/cli/media_pool_apply.php "
    . "--source=/path/to/migration.json --category=ID\n\n"
    . "Applies validated ILIAS Media Pool -> Moodle mod_data migration.\n";
...
$result = (
    new \local_iliasmigration\phase65_media_pool_executor($source)
